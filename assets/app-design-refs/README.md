...
这些是设计师产出的 App 视觉稿。看法跟 `cert-master/assets/app-design-refs/` 一样 —— **学 mascot 用法 / 配色调性 / 信息架构**，不复制像素。

当前 App Mobile 全局底部导航固定为 5 tab：**首页 / 课表 / AI 课代表 / 牛圈 / 我的**。
...
| 04 | `04-core-features.png` | 9 个核心功能 + 8 mascot 表情库 | 启动 / 首页 / 课表 / AI 课代表 / 复习卡 / DDL / Widget / 进度 / 我的 |
